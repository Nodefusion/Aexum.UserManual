...
You can view all users that are available within the Environment. Normally these are all users that are part of the Organization to which the Environment belongs.

Additionally, You have tabs, to show Assets, Teams, and Permission Groups for specific selected users within the Environment.
