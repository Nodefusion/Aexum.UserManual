...
There is button to create new environment for organization under grid of environments that takes user to create environments page.
...
* Environments - when clicked, opens page that displays Organizations environments for that organization. User can type new environment Name in field New Environment Name, and when
user clicks create button, new environment is created with name that user wrote. Under create form, there is environments grid with environments that are in organizations. In grid there
...
* About - when clicked, opens page with details about Application Name, WebAssembly Version and WebApi version. Also has link that takes user to Aexum User Manual page

#### Environment navmenu

In environmnet navmenu user can select next tabs:

* Home - when clicked, opens page where user sees details for his environment
...
* Asset Catalogs - when clicked, opens page where user can see grid with asset catalogs for his environment with search field above grid in Overview tab. In Create Asset Catalog
...
on role name in grid to take him to permission role edit page
...
* Admin/Asset Groups - when clicked, opens page with tree view of asset groups in environment. Create new asset group form is under tree view of asset groups. User can also click on name of asset group in tree view
